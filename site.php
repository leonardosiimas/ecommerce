...
$app->get("/cart/:idproducts/add", function($idproduct){
...
$app->get("/cart/:idproducts/minus", function($idproduct){
...
$app->get("/cart/:idproducts/remove", function($idproduct){
...
$app->post("/register", function(){
	...
	if(User::checkLoginExist($_POST['email']) === true){
		...
		User::setErrorRegister("Esse endereço de email já esta sendo utilizado.");
		header("Location: /login");
		exit;
...
$app->post("/profile", function(){
	...
	if ($_POST['desemail'] !== $user->getdesmail()) {
	...
	$_POST['inadimin'] = $user->getinadmin();
